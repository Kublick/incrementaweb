...
const formNumber = "59";
const formId = "6048f0791aee60b2ebe5e230d02633cc";
...
function ReplayFormulario() {
  ...
  return (
    <div>
      <h1 className="text-center text-xl font-semibold text-white md:text-3xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {hasError && (
          <p className="mt-2 rounded-sm bg-white px-4 py-1 text-sm text-red-500">
        ...
        <div className="flex justify-center">
          {!isSending ? (
            <button
              type="submit"
              className={`mt-8 bg-primary px-8 py-4 text-2xl text-white hover:bg-primary-dark`}
            >
            ...
            <button
              type="submit"
              className={`mt-8 flex gap-4 rounded-lg bg-green-600 px-8 py-4 text-2xl text-white`}
            >
